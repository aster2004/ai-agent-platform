  ...
  <div class="chat-home">
    ...
    <div class="home-center">
      ...
      <div class="feature-cards">
        <div class="feature-card" @click="setQuickPrompt('帮我写一个登录页面')">
        ...
        <div class="feature-card" @click="setQuickPrompt('解释一下什么是 RESTful API')">
        ...
        <div class="feature-card" @click="setQuickPrompt('帮我分析这段代码的时间复杂度')">
        ...
        <div class="feature-card" @click="setQuickPrompt('设计一个用户系统的数据库表结构')">
      ...
      <!-- 输入框 -->
      <ChatInput ref="inputRef" :is-home="true" @send="handleSend" />
