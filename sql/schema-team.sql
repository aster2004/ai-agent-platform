...
CREATE TABLE IF NOT EXISTS `chat_session` (
    ...
    `memory_summary`       TEXT         NULL COMMENT '跨轮会话概要（Layer 2 长期记忆）',
    `summary_updated_at`   DATETIME     NULL COMMENT 'memory_summary 最后更新时间',
    `summary_message_count` INT         NOT NULL DEFAULT 0 COMMENT '上次更新 summary 时的 message_count',
